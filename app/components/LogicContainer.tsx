		...
		<div className="min-h-screen bg-bgColor flex flex-col justify-start items-center">
			<div className="flex w-full flex-col items-center justify-center mb-8">
				<div className="flex w-full flex-row gap-10 mb-10">
					<div className="w-1/2">
						<NFTImage /> <BurnMintButtons onBurn={handleBurn} onMint={handleMint} />
					</div>
					<div className="w-1/2">
						...
						<div className="flex flex-col">
							...
							<div className="mt-5 w-full text-sm flex flex-col px-2 rounded-xl text-bgAccentOne text-center text-bold ">
